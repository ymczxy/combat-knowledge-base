...
RELATIONSHIP_ID = "rel:v1_6_1_batch_03:lee_enfield_no4_mk1:uses_ammunition:303_british"


class SmallArmsBatch03Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_batch_registers_two_entities_and_relation(self):
        batch = next(
            ...
            if row.get("batch_id") == "v1.6.1-small-arms-batch-03-lee-enfield"
        )
    ...
    def test_relation_is_independent_and_source_checked(self):
        ...
        self.assertEqual(relationship.source_id, "ckb:weapon:firearm:lee_enfield_no4_mk1")
        self.assertEqual(relationship.target_id, "ckb:ammunition:cartridge:303_british")
    ...
    def test_ammunition_profile_excludes_loading_recipe_fields(self):
        ...
        fields = {
            claim.get("field")
            for claim in self.entity_map["ckb:ammunition:cartridge:303_british"].technical["claims"]
        }
