...
- 按已批准版本边界完成装甲车辆、轻武器/弹药、航空、舰船/海军武器、火炮/导弹/防空/传感器五个领域闭环；不是将 v1.6 缩减为“首批切片”。
- 完成 Place、Country、Organization、Manufacturer、MilitaryUnit、Battle、Conflict、Person、Facility 九类上下文实体，以及时间轴、战役装备、产业链、工厂地点和部队编制五项规划输出。
- 新增关系面板、递归展开图谱、地图、发展谱系、高级筛选、本地查询 API 和事实 → 断言 → 来源证据回溯。
- 新增正式 Godot `.ckb` 导入插件、缓存、查询、兼容、升级和回滚链路，并在《destory》真实工程和官方 Godot 4.7.1 中完成运行验证。
- 发布快照固定 187 个实体、135 条独立关系、35 个内容批次、123 个技术档案和 521 条技术声明；数值单位未知项与实体内嵌关系均为 0。
- 七个 Runtime profile 全部纳入稳定性门禁；默认分支合并仍以远程 CKB CI 和 Godot Linux Runtime Smoke 全绿为最终条件。
